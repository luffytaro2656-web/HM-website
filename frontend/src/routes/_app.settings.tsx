...
const TABS = ["Profile", "Hospital Config", "User Management", "Role Privileges", "Notifications", "Security"] as const;
...
function SettingsPage() {
  ...
  const visibleTabs = TABS.filter((t) => {
    if (t === "Hospital Config") return canAccess("hospitals", "update");
    if (t === "User Management") return canAccess("settings", "read");
    if (t === "Role Privileges") return user?.role === "super_admin" || user?.backendRole === "Super Admin";
    return true;
  });
